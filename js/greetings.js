...
const HIDDEN_CLASSNAME =
  "hidden"; /*일반적으로 string만 포함된 변수는 대문자고 표기하고 string을 저장하고 싶을 때 사용한다.*/
...
function onLoginSubmit(event) {
  ...
  localStorage.setItem(
    USERNAME_KEY,
    username
  ); /*localstorage의 setItem, removeItem, getItem 을 이용해 작은 DB를 사용할 수 있다. */
...
//eventlistener 안에 있는 함수는 직접 실행하지 않는다.
